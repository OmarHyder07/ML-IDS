...
Figures 2 & 3: Weighted attack recall vs. FPR for LOF and iForest, over cross-validation and test sets. These contain different sets of unseen classes. Validation has Patator Brute Force, DoS attacks and Heartbleed. Test has Infiltration, DDoS, web attacks, PortScan, Botnet. 
![alt_text](https://github.com/OmarHyder07/ML-IDS/blob/main/cic-ids2017/docs/ranking_reversal_linkedin.png?raw=true)
